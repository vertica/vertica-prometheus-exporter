...
func ExporterHandlerFor(exporter vertica_exporter.Exporter) http.Handler {
...
func contextFor(req *http.Request, exporter vertica_exporter.Exporter) (context.Context, context.CancelFunc) {
